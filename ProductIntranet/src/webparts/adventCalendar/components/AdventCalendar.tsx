...
const dayContents = [
  ...
  { 'day': 4, 'content': "How many programmers does it take to changegu a light bulb? None, that's a hardware problem.", gifUrl: "https://media.giphy.com/media/Dk57URqjqjHjNGHeMV/giphy.gif" },
